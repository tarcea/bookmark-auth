  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        ...
        <h3>User journey</h3>
        <p>When you navigate at <span onClick={navigateTo("home")}><strong>https://mycoolbookmark.web.app</strong></span>, you can see the page with all public bookmarks from all users. Here you just can search bookmarks and visit the web pages.
